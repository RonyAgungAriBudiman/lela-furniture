		...
		<td>
			<table style="font-family:'Times New Roman'; font-size:14px; font-weight: bold;" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
				    ...
				    <td align="center" ><div align="left">LAPORAN PEMASUKAN BARANG PER DOKUMEN PABEAN</div></td>
				    <td align="center" >&nbsp;</td>
				</tr>
				<tr>
		...
		<td>
			<table style="font-family:'Times New Roman'; font-size:12px; border:solid 1px #000;" border="1" cellpadding="1" cellspacing="1" width="100%">
				<tr>
	                ...
	                <td style="font-weight: bold; text-align:center;" colspan="2" >Bukti Penerimaan Barang</td>
	                <td style="font-weight: bold; text-align:center;" rowspan="2">Pemasok/Pengirim</td>
	            ...
	            <?php
		            ...
		            foreach ($data as $row) 
		            {
		                ...
		                <tr>
		                    ...
		                    <td style="text-align:center;" ><?php echo trim($row['nomorDaftar']) ?></td>
		                    <td style="text-align:center;" ><?php echo date("d-M-Y",strtotime($row['tglDaftar'])); ?></td>
		                    <td style="text-align:center;" ><?php echo trim($row['receiveNumber']) ?></td>
		                    <td style="text-align:center;" ><?php echo date("d-M-Y",strtotime($row['receiveDate'])); ?></td>
