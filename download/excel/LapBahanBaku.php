...
$inputFileName = 'template/LapBahanBaku.xls';
...
$outputFileName = 'Laporan Pertanggungjawaban Mutasi Bahan Baku Dan Bahan Penolong.xls';
...
$objPHPExcel->getActiveSheet()->setCellValue('B3',  'KAWASAN BERIKAT '.strtoupper($data_cp[0]['NamaPerusahaan'])); 
...
$sql = "SELECT itemNo, itemName, unit1Name, itemCategory,
        ...
        SELECT a.itemNo, a.itemName, a.unit1Name, a.itemCategory,
            sum(a.awal) as awal, sum(0) as masuk, sum(0) as keluar, 
                ...
                sum(0) as selisih 
            FROM ac_stock a
        WHERE a.itemCategory ='Bahan Baku' AND a.tanggal ='".$_GET['dari']."' AND a.lokasiGudang='Utama'
        ...
        SELECT a.itemNo, a.itemName, a.unit1Name, a.itemCategory,
            ...
            FROM ac_stock a
        WHERE a.itemCategory ='Bahan Baku' AND a.tanggal>='".$_GET['dari']."' AND a.tanggal<='".$_GET['sampai']."' AND a.lokasiGudang='Utama'
        Group By a.itemNo, a.itemName, a.unit1Name, a.itemCategory , a.lokasiGudang 
