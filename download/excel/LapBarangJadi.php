...
$inputFileName = 'template/LapBarangJadi.xls';
...
$outputFileName = 'Laporan Pertanggungjawaban Mutasi Barang Jadi.xls';
...
$sql = "SELECT itemNo, itemName, unit1Name, itemCategory,
        ...
        SELECT a.itemNo, a.itemName, a.unit1Name, a.itemCategory,
            sum(a.awal) as awal, sum(0) as masuk, sum(0) as keluar, 
                ...
                sum(0) as selisih 
            FROM ac_stock a
        WHERE a.itemCategory ='Finish Good' AND a.tanggal ='".$_GET['dari']."' AND a.lokasiGudang='Finish Good'
        ...
        SELECT a.itemNo, a.itemName, a.unit1Name, a.itemCategory,
            ...
            FROM ac_stock a
        WHERE a.itemCategory ='Finish Good' AND a.tanggal>='".$_GET['dari']."' AND a.tanggal<='".$_GET['sampai']."'  AND a.lokasiGudang='Finish Good'
        Group By a.itemNo, a.itemName, a.unit1Name, a.itemCategory, a.lokasiGudang   
