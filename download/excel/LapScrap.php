...
$inputFileName = 'template/LapScrap.xls';
...
$outputFileName = 'Laporan Pertanggungjawaban Mutasi Barang Sisa Dan Scrap.xls';
...
$sql = "SELECT itemNo, itemName, unit1Name, itemCategory,
        ...
        Group By a.itemNo, a.itemName, a.unit1Name, a.itemCategory , a.itemCategory
        UNION ALL
